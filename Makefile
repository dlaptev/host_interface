...
# Generated by qmake (2.01a) (Qt 4.5.2) on: Mon Jul 27 23:28:56 2009
...
SOURCES       = main.cpp \
		...
		interface_view.cpp \
		second_view.cpp moc_qtsvgbutton.cpp \
		moc_terminal_interface.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/host_interface1.0.0/ && $(COPY_FILE) --parents qtsvgbutton.h terminal_manager.h terminal_interface.h interface_view.h second_view.h .tmp/host_interface1.0.0/ && $(COPY_FILE) --parents main.cpp qtsvgbutton.cpp terminal_manager.cpp terminal_interface.cpp interface_view.cpp second_view.cpp .tmp/host_interface1.0.0/ && (cd `dirname .tmp/host_interface1.0.0` && $(TAR) host_interface1.0.0.tar host_interface1.0.0 && $(COMPRESS) host_interface1.0.0.tar) && $(MOVE) `dirname .tmp/host_interface1.0.0`/host_interface1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/host_interface1.0.0
...
compiler_moc_header_make_all: moc_qtsvgbutton.cpp moc_terminal_interface.cpp moc_interface_view.cpp moc_second_view.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_qtsvgbutton.cpp moc_terminal_interface.cpp moc_interface_view.cpp moc_second_view.cpp
moc_qtsvgbutton.cpp: qtsvgbutton.h
	/usr/bin/moc $(DEFINES) $(INCPATH) qtsvgbutton.h -o moc_qtsvgbutton.cpp

moc_terminal_interface.cpp: interface_view.h \
		terminal_interface.h
	/usr/bin/moc $(DEFINES) $(INCPATH) terminal_interface.h -o moc_terminal_interface.cpp

moc_interface_view.cpp: interface_view.h
	/usr/bin/moc $(DEFINES) $(INCPATH) interface_view.h -o moc_interface_view.cpp

moc_second_view.cpp: interface_view.h \
		qtsvgbutton.h \
		second_view.h
	/usr/bin/moc $(DEFINES) $(INCPATH) second_view.h -o moc_second_view.cpp
...
second_view.o: second_view.cpp second_view.h \
		interface_view.h \
		qtsvgbutton.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o second_view.o second_view.cpp

moc_qtsvgbutton.o: moc_qtsvgbutton.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_qtsvgbutton.o moc_qtsvgbutton.cpp

moc_terminal_interface.o: moc_terminal_interface.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_terminal_interface.o moc_terminal_interface.cpp

moc_interface_view.o: moc_interface_view.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_interface_view.o moc_interface_view.cpp

moc_second_view.o: moc_second_view.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_second_view.o moc_second_view.cpp
